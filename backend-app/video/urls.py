...
from .views import VideoUploadView, VideoGetView, VideoPartGetView, VideoListGetView
...
urlpatterns = [
    ...
    url(r'^get/(?P<key>[0-9a-z]{12})/$', VideoGetView.as_view()),
    url(r'^list/$', VideoListGetView.as_view()),
]